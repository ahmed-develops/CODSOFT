...
const ProductPage = () => {
    ...
    const takeMeToCart = () => {
        navigate('/cart-page', {state : state});
    }
            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-half lg:h-auto h-32 object-cover object-center rounded" src={state.image} />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                    ...
                                    {state.size1 ?
                                        <div className="relative">
                                            <select className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10">
                                                <option>{state.size1}</option>
                                                <option>{state.size2}</option>
                                                <option>{state.size3}</option>
                                                <option>{state.size4}</option>
                                            </select>
                            ...
                            <div className="flex">
                                ...
                                <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={takeMeToCart}>Add to Cart</button>
